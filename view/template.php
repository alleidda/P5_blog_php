...
<html lang="fr">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
                <a class="navbar-brand" href="accueil">@addielladotexe</a>
        ...
        <footer class="py-2 bg-dark ">
            <div class="container-fluid">
                ...
                <div class="social text-center">
                    <a class="btn btn-primary" href="https://www.linkedin.com/in/addi%C3%ABlla-amouzoun-4896ab184/" target="_blank"><i class="fa fa-linkedin fa-2x"></i></a>
                    <a class="btn btn-primary" href="https://github.com/alleidda" target="_blank"><i class="fa fa-github fa-2x"></i></a>
